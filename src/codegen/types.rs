    ...
    fn dimension_impl(&self, name: &Name, ty: &Ident) -> Option<TokenStream> {
        ...
        Some(quote! {
            impl ::sbe_support::Dimension for #ty {
                ...
                fn write_block<A: ::sbe_support::Allocator>(buf: &mut ::sbe_support::Vec<u8, A>, at: usize, block_length: usize) {
                    ::sbe_support::write_bytes_at(buf, at + core::mem::offset_of!(Self, #block_field), &(#block_value));
                }
                fn write_count<A: ::sbe_support::Allocator>(buf: &mut ::sbe_support::Vec<u8, A>, at: usize, count: usize) {
